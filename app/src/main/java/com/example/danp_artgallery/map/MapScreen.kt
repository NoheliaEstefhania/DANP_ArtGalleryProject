...
import com.example.danp_artgallery.screens.section.BeaconsDetailFunction
import com.example.danp_artgallery.screens.section.beaconList


val title = "SELECT THE ART GALLERY"
@Composable
fun MapScreen(){
    Scaffold(
        topBar = {
